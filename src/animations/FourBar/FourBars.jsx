...
export default function FourBars() {
  ...
  return (
    <div className=" h-screen overflow-x-hidden relative flex justify-center">
      ...
      <div id="chosenBar" className="translate-y-[400px] rotate-[-18deg] w-[2500px] absolute">
      ...
      <div id="highlightBar" className="translate-y-[400px]  rotate-[15deg] w-[2500px] absolute">
