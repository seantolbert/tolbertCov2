    ...
    <>
      <main className="h-screen text-black dark:text-white w-screen overflow-hidden">
        <div className="flex flex-col gap-2 items-start justify-center h-full w-full">
          <div
            id="moon"
            className="border-[20px] border-t-amber-500 border-r-amber-500 border-b-amber-500 border-l-transparent absolute w-[400px] h-[400px] rounded-full opacity-0"
          ></div>
          <div
            id="moon2"
            className="border-[20px] border-t-amber-500 border-r-amber-500 border-b-amber-500 border-l-transparent absolute w-[400px] h-[400px] rounded-full opacity-0"
          ...
          <div
            id="piece"
            className="border-[20px] border-l-amber-500 border-y-transparent border-r-transparent absolute w-[400px] h-[400px] rounded-full opacity-0"
          ></div>
          <div
            id="piece2"
            className="border-[20px] border-l-amber-500 border-y-transparent border-r-transparent absolute w-[400px] h-[400px] rounded-full opacity-0"
